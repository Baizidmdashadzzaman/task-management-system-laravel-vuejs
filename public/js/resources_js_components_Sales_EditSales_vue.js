...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    axios.get("/api/sales-edit/".concat(this.$route.params.id)).then(function (response) {
      ...
      _this.sales.sales_number = response.data.sales.sales_number;
      _this.sales.customer_id = response.data.sales.customer_id;
      _this.sales.total = response.data.sales.total_amount;
      _this.sales.sales_date = response.data.sales.sales_date;
      _this.sales.paid = response.data.sales.paid_amount;
      _this.sales.status = response.data.sales.status;
      _this.sales.discount = response.data.sales.discount;
      _this.sales.discounttype = response.data.sales.discount_type;
      _this.sales.discountammount = response.data.sales.discount_ammount;
      _this.sales.remaining = response.data.sales.remaining_ammount;
      _this.sales.subtotal = response.data.sales.sub_total;
      _this.sales.id = response.data.sales.id;
      _this.userCartcheck.sales_id = response.data.sales.id;
      _this.salesCartModal.sales_id = response.data.sales.id;
      _this.searchproductbycode.sales_id = response.data.sales.id;
      _this.allsalesproduct = response.data.saleproduct;
    });
    window.scrollTo(0, 0);
  ...
  methods: {
    searchProductByCode: function searchProductByCode() {
      ...
      var uri = '/api/product-search-bycode-whenedit';
      axios.post(uri, this.searchproductbycode).then(function (response) {
        if (response.data.status == 2) {
          ...
          if (response.data.status == 0) {
            ...
            _this2.salesCartModal.product_sales_qty = response.data.productSalesCart.sales_quantity;
            _this2.salesCartModal.product_sales_price = response.data.productSalesCart.product_price;
    ...
    submitSalesOrder: function submitSalesOrder() {
      ...
      var uri = '/api/sales-save-whenedit';
    ...
    deleteSalesCart: function deleteSalesCart(id) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          axios.get("/api/salesproduct-delete-whenedit/".concat(id, "/").concat(_this4.sales.id)).then(function (response) {
            if (response.data.status == 0) {
              Swal.fire({
                icon: 'error',
                text: response.data.message,
              ...
              _this4.sales.sales_number = response.data.sales.sales_number;
              _this4.sales.customer_id = response.data.sales.customer_id;
              _this4.sales.total = response.data.sales.total_amount;
              _this4.sales.sales_date = response.data.sales.sales_date;
              _this4.sales.paid = response.data.sales.paid_amount;
              _this4.sales.status = response.data.sales.status;
              _this4.sales.discount = response.data.sales.discount;
              _this4.sales.discounttype = response.data.sales.discount_type;
              _this4.sales.discountammount = response.data.sales.discount_ammount;
              _this4.sales.remaining = response.data.sales.remaining_ammount;
              _this4.sales.subtotal = response.data.sales.sub_total;
              _this4.sales.id = response.data.sales.id;
              _this4.allsalesproduct = response.data.saleproduct;
              Swal.fire({
                icon: 'success',
                text: response.data.message,
                showConfirmButton: true,
    ...
    submitSalesCart: function submitSalesCart() {
      ...
      var uri = '/api/product-addtosalescart-save-whenedit';
      axios.post(uri, this.salesCartModal).then(function (response) {
        _this5.salesCartModal.processing = false;
        _this5.sales.sales_number = response.data.sales.sales_number;
        _this5.sales.customer_id = response.data.sales.customer_id;
        _this5.sales.total = response.data.sales.total_amount;
        _this5.sales.sales_date = response.data.sales.sales_date;
        _this5.sales.paid = response.data.sales.paid_amount;
        _this5.sales.status = response.data.sales.status;
        _this5.sales.discount = response.data.sales.discount;
        _this5.sales.discounttype = response.data.sales.discount_type;
        _this5.sales.discountammount = response.data.sales.discount_ammount;
        _this5.sales.remaining = response.data.sales.remaining_ammount;
        _this5.sales.subtotal = response.data.sales.sub_total;
        _this5.sales.id = response.data.sales.id;
        _this5.userCartcheck.sales_id = response.data.sales.id;
        _this5.salesCartModal.sales_id = response.data.sales.id;
        _this5.allsalesproduct = response.data.saleproduct;
    ...
    addToSalesCart: function addToSalesCart(id) {
      ...
      var uri = '/api/product-addtosalescart-check-whenedit';
      axios.post(uri, this.userCartcheck).then(function (response) {
        if (response.data.status == 0) {
          ...
          _this6.salesCartModal.product_code = response.data.product.product_code_custome;
          ...
          _this6.salesCartModal.product_sales_qty = response.data.productSalesCart.sales_quantity;
          _this6.salesCartModal.product_sales_price = response.data.productSalesCart.product_price;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _EditSales_vue_vue_type_template_id_2bf2f6b8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EditSales.vue?vue&type=template&id=2bf2f6b8& */ "./resources/js/components/Sales/EditSales.vue?vue&type=template&id=2bf2f6b8&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  _EditSales_vue_vue_type_template_id_2bf2f6b8___WEBPACK_IMPORTED_MODULE_0__.render,
  _EditSales_vue_vue_type_template_id_2bf2f6b8___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/***/ "./resources/js/components/Sales/EditSales.vue?vue&type=template&id=2bf2f6b8&":
/*!************************************************************************************!*\
  !*** ./resources/js/components/Sales/EditSales.vue?vue&type=template&id=2bf2f6b8& ***!
  \************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EditSales_vue_vue_type_template_id_2bf2f6b8___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EditSales_vue_vue_type_template_id_2bf2f6b8___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_EditSales_vue_vue_type_template_id_2bf2f6b8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./EditSales.vue?vue&type=template&id=2bf2f6b8& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Sales/EditSales.vue?vue&type=template&id=2bf2f6b8&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Sales/EditSales.vue?vue&type=template&id=2bf2f6b8&":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Sales/EditSales.vue?vue&type=template&id=2bf2f6b8& ***!
  \***************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      _c("div", { staticClass: "container-fluid" }, [
        _c("div", { staticClass: "row mb-2" }, [
          _c("div", { staticClass: "col-sm-6" }, [
            _c("h1", [
              _vm._v("Edit Sales: #sale-" + _vm._s(_vm.sales.sales_number))
            ])
          ]),
          _vm._v(" "),
          _vm._m(0)
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.sales.sales_date,
                        expression: "sales.sales_date"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: { type: "date" },
                    domProps: { value: _vm.sales.sales_date },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.sales, "sales_date", $event.target.value)
                      }
                    }
                  })
                ]
                ...
                _c("div", { staticClass: "table-responsive" }, [
                  _c(
                    ...
                    [
                      _c(
                        "tbody",
                        _vm._l(_vm.allsalesproduct, function(salescart) {
                            ...
                            _c(
                              ...
                              [
                                ...
                                _c("font", { attrs: { size: "1px" } }, [
                                  _vm._v(
                                    "Price: " +
                                      _vm._s(salescart.product_price) +
                                      " * Qty: " +
                                      _vm._s(salescart.sales_quantity)
                                  )
                                ])
                              ],
                              1
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.sales.status,
                            expression: "sales.status"
                          }
                        ],
                        staticClass: "form-control",
                        attrs: { name: "status" },
              ...
              _c(
                ...
                [
                  _vm._v(
                    "\r\n                    " +
                      _vm._s(
                        _vm.sales.processing ? "Please wait" : "Update order?"
                      ) +
                      "\r\n                  "
                  )
                ]
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "col-sm-6" }, [
      _c("ol", { staticClass: "breadcrumb float-sm-right" }, [
        ...
        _vm._v(" "),
        _c("li", { staticClass: "breadcrumb-item active" }, [_vm._v("Sales")]),
        _vm._v(" "),
        _c("li", { staticClass: "breadcrumb-item active" }, [_vm._v("Edit")])
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "card-header" }, [
      _c("h3", { staticClass: "card-title" }, [_vm._v("Sold product")]),
      _vm._v(" "),
      _c("div", { staticClass: "card-tools" }, [
        _c(
          "button",
  ...
  function() {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      _c("h4", { staticClass: "modal-title" }, [_vm._v("Update sales order")]),
      _vm._v(" "),
      _c(
        "button",
        {
