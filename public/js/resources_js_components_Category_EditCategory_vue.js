(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_Category_EditCategory_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    axios.get("/api/category-edit/".concat(this.$route.params.id)).then(function (response) {
      _this.user.category_name = response.data.singledata.category_name;
      _this.user.category_image = response.data.singledata.category_image;
      _this.user.category_status = response.data.singledata.category_status;
  ...
  methods: {
    onImageChange: function onImageChange(e) {
      this.user.category_image = e.target.files[0];
    },
    submitdata: function submitdata(e) {
      ...
      formData.append('category_name', this.user.category_name);
      formData.append('category_image', this.user.category_image);
      formData.append('category_status', this.user.category_status);
      formData.append('id', this.user.id);
      axios.post('/api/category-update', formData, config).then(function (res) {
                  ...
                  _c("div", { staticClass: "card-body" }, [
                      ...
                      [
                        _c("center", [
                          _c("img", {
                            ...
                            attrs: {
                              src: "/categoryimages/" + _vm.user.category_image,
                              alt: ""
                            }
                          })
                        ])
                    ...
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.user.category_name,
                            expression: "user.category_name"
                          }
                        ],
                        ...
                        domProps: { value: _vm.user.category_name },
                        on: {
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.user.category_status,
                              expression: "user.category_status"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { name: "category_status" },
                          on: {
