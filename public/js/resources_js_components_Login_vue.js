...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    axios.get("/api/setting").then(function (response) {
      _this.setting.site_name = response.data.allData.site_name;
      _this.setting.site_logo = response.data.allData.site_logo;
      _this.setting.site_favicon = response.data.allData.site_favicon;
      _this.setting.site_information = response.data.allData.site_information;
      _this.setting.site_phone = response.data.allData.site_phone;
      _this.setting.site_email = response.data.allData.site_email;
      _this.setting.site_fb = response.data.allData.site_fb;
      _this.setting.site_meta_keyword = response.data.allData.site_meta_keyword;
      _this.setting.site_meta_description = response.data.allData.site_meta_description;
    });
  },
...
var render = function() {
  ...
  return _c("div", { staticClass: "container h-100 login-box " }, [
    _c("div", { staticClass: "row h-100 align-items-center" }, [
      _c("div", { staticClass: "col-12 col-md-6 offset-md-3" }, [
        _c(
          "div",
          { staticClass: "card shadow sm card-outline card-primary " },
          [
            _c(
              "div",
              ...
              [
                ...
                _c(
                  ...
                  [
                    _c(
                      "div",
                      { staticClass: "input-group mb-3 form-group col-12 " },
                      [
                        _c("input", {
                          directives: [
                            {
                ...
                _vm._v(" "),
                _c("center", [
                  _c("b", [_vm._v("Developed by")]),
                  _vm._v(" "),
                  _c(
                    "a",
                    {
                      attrs: {
                        href: "https://www.softscandic.com",
                        target: "_blank"
                      }
                    },
                    [
                      _c("img", {
                        ...
                        attrs: { src: "/resource/scandicsoft-logo-black.png" }
                      })
                    ]
                  )
                ])
