(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_Category_AddCategory_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    submitdata: function submitdata(e) {
      ...
      axios.post('/api/category-store', formData, config).then(function (res) {
        _this.processing = false;
        _this.user.category_name = '';
        _this.user.category_image = '';
        _this.user.category_status = 1;
